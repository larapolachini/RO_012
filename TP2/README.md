...
Le fichier ParticleFilter.py a été complété afin d’intégrer l’ensemble des équations du filtre particulaire (PF). Le modèle dynamique, le modèle de mesure ainsi que les matrices jacobiennes associées ont été implémentés conformément aux équations du cours.
